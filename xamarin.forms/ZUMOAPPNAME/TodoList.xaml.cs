...
namespace ZUMOAPPNAME
{
    public partial class TodoList : ContentPage
    {
        ...
        {
            var todo = new TodoItem { works = newItemName.Text };
            await AddItem(todo);
        ...
        public async void OnSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            if (Device.RuntimePlatform != Device.iOS && todo != null)
            {
                ...
                {
                    await DisplayAlert(todo.names, "Press-and-hold to complete task " + todo.names, "Got it!");
                }
                else
                {
                    // Windows, not all platforms support the Context Actions yet
                    if (await DisplayAlert("Mark completed?", "Do you wish to complete " + todo.names + "?", "Complete", "Cancel"))
                    {
